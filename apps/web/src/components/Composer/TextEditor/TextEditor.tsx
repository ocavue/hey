    ...
    <ProseKit editor={editor}>
      <div className="box-border flex h-full w-full justify-stretch overflow-y-auto overflow-x-hidden px-5 py-4">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <EmojiPicker />
          <div
            className='[&_span[data-mention="user"]]:text-brand-500 [&_a]:text-brand-500 relative mt-[8.5px] box-border h-full min-h-[80px] flex-1 overflow-auto leading-6 outline-0 sm:leading-[26px]'
            ref={editor.mount}
          />
        </div>
      </div>
