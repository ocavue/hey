...
export default function InlineMenu() {
  ...
  return (
    <>
      ...
      <InlinePopover
        className="w-xs relative z-10 box-border flex flex-col items-stretch gap-y-2 rounded-lg border border-zinc-200 bg-white p-4 shadow-lg dark:border-zinc-800 dark:bg-neutral-900"
